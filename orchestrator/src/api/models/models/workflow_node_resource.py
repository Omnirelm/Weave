...
class WorkflowNodeResource(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "type", "agent_id", "objective"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of WorkflowNodeResource from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of WorkflowNodeResource from a dict"""
        if obj is None:
            return None
