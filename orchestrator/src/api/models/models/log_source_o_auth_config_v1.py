...
class LogSourceOAuthConfigV1(BaseModel):
    """
    OAuth 2.0 Client Credentials configuration for log sources (same as RCA engine).
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LogSourceOAuthConfigV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LogSourceOAuthConfigV1 from a dict"""
        if obj is None:
            return None
