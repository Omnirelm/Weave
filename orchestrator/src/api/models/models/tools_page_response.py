...
from .tool_v1 import ToolV1
from typing import Optional, Set
from typing_extensions import Self
from pydantic_core import to_jsonable_python

class ToolsPageResponse(BaseModel):
    """
    ToolsPageResponse
    """ # noqa: E501
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ToolsPageResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ToolsPageResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [ToolV1.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
