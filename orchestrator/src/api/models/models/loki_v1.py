...
class LokiV1(BaseModel):
    """
    Loki is a log aggregation system.
    """ # noqa: E501
    type: StrictStr
    flavour: StrictStr
    url: StrictStr = Field(description="URL of the Loki cluster.", json_schema_extra={"examples": ["http://localhost:3100"]})
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LokiV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LokiV1 from a dict"""
        if obj is None:
            return None
