...
class TempoV1(BaseModel):
    """
    Grafana Tempo distributed tracing backend.
    """ # noqa: E501
    type: StrictStr
    flavour: StrictStr
    url: StrictStr = Field(description="Tempo query API base URL.", json_schema_extra={"examples": ["http://localhost:3200"]})
    ...
    def flavour_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['TEMPO']):
            raise ValueError("must be one of enum values ('TEMPO')")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TempoV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TempoV1 from a dict"""
        if obj is None:
            return None
